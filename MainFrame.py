...
class MainFrame(Frame):
		...
		def _create_container_image(self, cnvs_wth, cnvs_hgt, cntr_wth, cntr_hgt, cntr_stx, cntr_sty, work_wth, work_hgt, work_stx, work_sty):
				...
				# This defines the total space taken up for RUs to be drawn
				# So basically the total height of the container minus the top and bottom lips.
				...
				for iter in range(self.rack_units-1):
